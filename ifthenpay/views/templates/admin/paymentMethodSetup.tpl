...
<div class="panel">
	...
	<div class="iftp_payment_method">
		<div class="payment-method_image">
			<img src="{$module_dir|escape:'html':'UTF-8'}/views/img/{$paymentMethod}.png" height="40">
		</div>

		<div class="panel-body payment-method_text">
