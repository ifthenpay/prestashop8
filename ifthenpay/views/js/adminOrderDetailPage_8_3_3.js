...
/******/
    ...
    */
    ...
    function (_super) {
      ...
      AdminOrderDetailPage.prototype.chooseNewPaymentMethod = function (event) {
        ...
        if ($('#cancelPaymentMethod').length === 0) {
          ...
          Object.keys(this.ifthenpayUserPaymentMethods).forEach(function (key) {
            if (_this.ifthenpayUserPaymentMethods[key] !== 'ccard' && _this.ifthenpayUserPaymentMethods[key] !== 'cofidispay' && _this.ifthenpayUserPaymentMethods[key] !== 'pix') {
          ...
          this.documentFragment.append("<button id=\"cancelPaymentMethod\" class=\"btn btn-danger\">".concat(strCancel, "</button>\n                <button id=\"changePaymentMethod\" class=\"btn btn-primary\">").concat(strChangeMethod, "</button>"));
          this.eventTarget.parent().append(this.documentFragment);
          $('#changePaymentMethodSelect').after("<input id=\"mbway_input\" name=\"ifthenpayMbwayPhone\" type=\"text\" class=\"form-control mbway_re_input\" placeholder=\"".concat(strMbwayNumber, "\" value=\"\">"));
      ...
      AdminOrderDetailPage.prototype.showMessageInGUIBootstrap = function (msg) {
        var msgContainer = document.querySelector('.panel-order-ifthenpay .validation');

        if (msgContainer) {
          var flashMessageContainer = document.querySelector('.panel-order-ifthenpay .flash_message');
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/ddev/prestashop8/modules/ifthenpay/_dev/js/adminOrderDetailPage.ts */
    "./_dev/js/adminOrderDetailPage.ts");
    /***/
  }
  /******/
