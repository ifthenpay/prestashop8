...
class MultibancoConfigForm extends ConfigForm
{
	...
	public function isValid()
	{
		...
		if ($entity == '') {
			Utility::setPrestashopCookie('error', $this->ifthenpayModule->l('Selected Entity is not valid', pathinfo(__FILE__)['filename']));
			return false;
		}

		if ($subEntity == '') {
			Utility::setPrestashopCookie('error', $this->ifthenpayModule->l('Selected SubEntity is not valid', pathinfo(__FILE__)['filename']));
			return false;
		}
