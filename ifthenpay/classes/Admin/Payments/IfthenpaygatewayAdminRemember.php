...
class IfthenpaygatewayAdminRemember extends IfthenpaygatewayBase implements AdminRememberInterface
{
	...
	public function rememberPayment()
	{
		...
		$this->sendEmail('ifthenpaygateway_relembrar', Utility::getMailTranslationString('ifthenpaygateway'));
	}
}
