...
class PayshopAdminRefund extends PayshopBase implements AdminRefundInterface
{
    public function refundPayment()
    {
        ...
        $this->sendEmail('refund', 'Confirmação de Reembolso');//Utility::getMailTranslationString('payshop'));
