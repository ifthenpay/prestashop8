...
use PrestaShop\Module\Ifthenpay\Factory\Admin\AdminRememberFactory;
...
class IfthenpayAdminRemember extends IfthenpayStrategy
{
    ...
    public function execute()
    {
        ...
        AdminRememberFactory::build($this->order->payment, $this->paymentDefaultData, $this->ifthenpayModule, null, $this->emailDefaultData)->rememberPayment();
    }
}
