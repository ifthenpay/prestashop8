...
use PrestaShop\Module\Ifthenpay\Factory\Admin\AdminResendFactory;
...
class IfthenpayAdminResend extends IfthenpayStrategy
{
    ...
    public function execute()
    {
        ...
        AdminResendFactory::build($this->order->payment, $this->paymentDefaultData, $this->ifthenpayModule, null, $this->emailDefaultData)->resendPayment();
    }
}
