...
class Ifthenpaygateway extends MasterPayment implements PaymentMethodInterface
{
	...
	private function requestIfthenpaygatewayLink(): void
	{
		...
		$successUrl = $baseCallbackUrl . '?type=online&p=ifthenpaygateway&cartId=' . \Tools::getValue('id_cart') . '&oid=' . \Tools::getValue('id_order') . '&qn=' . Token::encrypt(Status::getStatusSuccess());
