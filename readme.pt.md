...
| Ifthenpay v8.3.5 | Não compatível | Compatível | Compatível                    |



Nota: A versão v8.3.2 do Ifthenpay pode funcionar no Prestashop 9, mas é aconselhável atualizar/utilizar a versão v8.3.5 ou superior do Ifthenpay para plataformas Prestashop de versão 9 ou superior.
...
**Nota importante:** Não é possível mudar ou atualizar para os métodos de pagamento de Cartão de Crédito e Pix.
...
> **Nota:** Disponível a partir da versão 8.3.4.
