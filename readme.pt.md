# Módulo de pagamentos Ifthenpay Prestashop 8

Ler em ![Português](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/en/pt.png) [Português](readme.pt.md), e ![Inglês](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/en/en.png) [Inglês](readme.md)
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/en/release.png)
</br>

* Descarregar o instalador zip com nome "ifthenpay.zip";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/en/release_download.png)
</br>

* Ou se está a atualizar, descarregar no Prestashop em Módulos/Ifthenpay/Configurar;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/upgrade_download.png)
</br>

* Ir a Module Manager;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/module_manager.png)
</br>

* Clicar em "Enviar um módulo";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/click_upload_module.png)
</br>

* Arrastar o instalador zip para a caixa "Enviar um módulo";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/drag_upload_module.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/click_configure.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/insert_backoffice_key.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/enable_multibanco.png)
</br>

## Multibanco

* Clicar no botão " GERIR" abaixo de Multibanco para configurar o método de pagamento Multibanco;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/manage_multibanco.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/config_multibanco.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/multibanco_callback_activated.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/config_multibanco_dynamic.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/manage_mbway.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/config_mbway.png)
</br>

* Se selecionou "Callback" ativado anteriormente, após salvar, o estado do Callback será mostrado abaixo com a Chave Anti-Phishing e Url de Callback criados;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_callback_activated.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/manage_ccard.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/config_ccard.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/manage_payshop.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/config_payshop.png)
</br>

* Se selecionou "Callback" ativado anteriormente, após salvar, o estado do Callback será mostrado abaixo com a Chave Anti-Phishing e Url de Callback criados;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/payshop_callback_activated.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/update_payment_data.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/resend_payment_data.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/remember_payment_details.png)
</br>
...
Escolher outro método de pagamento:
  ...
  * Clicar no botão "Escolher Novo Método de Pagamento";
  ![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/choose_payment_method.png)
</br>
  ...
  * Selecionar novo método de pagamento dos disponíveis no "dropdown" que acabou de aparecer (1), e clicar em "Alterar Método de Pagamento" (2);
  ![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/select_payment_method.png)
</br>
  ...
  * Os detalhes de pagamento serão atualizados com o novo método de pagamento, agora deve clicar no botão "Reenviar Dados de Pagamento" para notificar o consumidor da alteração;
  ![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/new_payment_method.png)
</br>
  ...
  * Se está a mudar de Multibanco ou Payshop para MB WAY, precisa de inserir o número de telemóvel do consumidor e clicar no botão "Alterar Método de Pagamento". Esta ação envia notificação MB WAY automaticamente, mas pode usar o botão " Reenviar Dados de Pagamento" se o consumidor não pagou dentro dos 5 minutos de tempo limite e necessita de outra notificação para a app MB WAY;
    ![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/change_to_mbway_payment.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/support.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/request_account.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/request_account_creation.png)


## Logs

* Pode consultar os logs relativos ao módulo em Módulos/Ifthenpay/Configurar, clicando na tab "LOGS";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/click_logs.png)
</br>

* Os logs registam erros e outros eventos que podem ajudar a detetar a fonte de um problema;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/logs.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/reset.png)
</br>

* Após reinicializar, ser-lhe-á mais uma vez pedido para inserir a Chave Backoffice;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/backoffice_key.png)
</br>

## Atualizações

* Em Módulos/Ifthenpay/Configurar, no fim da página é possível verificar se existem atualizações disponíveis para o módulo;
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/update.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/sandbox_mode.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/callback_status_disabled.png)
</br>

2. Callback ativo (a encomenda muda de estado quando recebe o pagamento);
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/callback_status_activated.png)
</br>

3. Callback ativo e Modo Sandbox ativo (a encomenda não muda de estado quando recebe o pagamento);
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/callback_status_sandbox.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/multibanco_callback_data.png)
</br>

para preencher o formulário de Testar Callback e clicar no botão "Testar Callback" (3):
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/multibanco_callback_test.png)
</br>
</br>

**MB WAY:** Use os dados seguintes (1) e (2) dos detalhes de pagamento de encomenda:

![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_callback_data.png)
</br>

para preencher o formulário de Testar Callback e clicar no botão "Testar Callback" (3):
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_callback_test.png)
</br>
</br>

**Payshop:** Use os dados seguintes (1) e (2) dos detalhes de pagamento de encomenda:
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/payshop_callback_data.png)
</br>

para preencher o formulário de Testar Callback e clicar no botão "Testar Callback" (3):
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/payshop_callback_test.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/en/ccc_fix.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/checkout_multibanco.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/multibanco_payment_return.png)
</br>
...
2. Colocar o visto nos "termos do serviço" (Depende da sua configuração do Prestashop);
3. Clicar no botão "PLACE ORDER";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/checkout_payshop.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/payshop_payment_return.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/checkout_mbway.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_payment_return.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_payment_paid.png)
</br>

2. se rejeitou o pagamento na app MB WAY, o contador irá atualizar com "Pagamento Recusado!";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_payment_refused.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_payment_error.png)
</br>

* terminou o tempo, pode reenviar uma notificação MB WAY clicando no botão "REENVIAR NOTIFICAÇÃO MB WAY";
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/mbway_payment_notification_resend.png)
</br>
...
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/ccard_payment.png)
</br>

* Após pagar, será redirecionado de volta para a loja,
![img](https://github.com/ifthenpay/prestashop/raw/assets/readme_img/pt/ccard_payment_return.png)
</br>
