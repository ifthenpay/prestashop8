...
use PrestaShop\Module\Ifthenpay\Factory\Admin\AdminUpdateFactory;
...
class IfthenpayAdminUpdate extends IfthenpayStrategy
{
    ...
    public function execute()
    {
        ...
        AdminUpdateFactory::build($this->order->payment, $this->paymentDefaultData, $this->ifthenpayModule)->updatePayment();
    }
}
